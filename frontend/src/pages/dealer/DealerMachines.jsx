  ...
  return (
    <div>
      <div style={{ marginBottom: '2rem' }}>
        <h1 style={{ fontSize: '2rem', marginBottom: '0.5rem', fontFamily: 'Manrope, sans-serif', color: 'var(--text)' }}>Fleet Inventory</h1>
        <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem' }}>Manage all your registered machines.</p>
      </div>
